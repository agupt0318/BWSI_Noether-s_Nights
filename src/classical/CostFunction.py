...
def make_edge_for_each_verticx_n_steps_away(edges, num_nodes, n):
...
def generate_regular_graph_edges(n, num_nodes):
    edges = set()
    if n == 1:
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 4)
    elif n == 2:
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 1)
    elif n == 3:
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 4)
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 3)
    elif n == 4:
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 1)
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 2)
    elif n == 5:
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 4)
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 3)
        edges = make_edge_for_each_verticx_n_steps_away(edges, num_nodes, 2)
